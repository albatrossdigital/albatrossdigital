...
class __TwigTemplate_456c3c473758f0fb10d63fa0c107b634 extends Drupal\Core\Template\TwigTemplate
{
  ...
  ";
    ...
    ";
            ...
            if ((isset($context["caption"]) ? $context["caption"] : null)) {
                // line 33
                echo "      ";
                echo twig_render_var($this->getContextReference($context, "caption"));
                echo "
    ";
            } else {
                // line 35
    ...
    ";
        ...
        ";
                ...
                if ((!twig_test_empty((isset($context["summary"]) ? $context["summary"] : null)))) {
                    // line 40
                    echo "          <summary>";
                    echo twig_render_var($this->getContextReference($context, "summary"));
                    echo "</summary>
        ";
                }
                // line 42
      ...
      <tr>
        ";
            ...
            foreach ($context['_seq'] as $context["_key"] => $context["column"]) {
                // line 53
                echo "          <th";
                echo twig_render_var($this->getAttribute($this->getContextReference($context, "column"), "attributes"));
                echo " scope=\"col\">
            ";
                // line 54
                echo twig_render_var($this->getAttribute($this->getContextReference($context, "column"), "content"));
                echo "
          </th>
        ";
            }
